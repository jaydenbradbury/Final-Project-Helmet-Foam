...
We will be using a mixed model for our analysis. A mixed model is used when there is variation
```{=html}
<!--
...
In @Model_pvalue, we can see that all terms included in the model are significant with p-values $< .0001$.
...
For the most consistent static stiffness, a foam with high porosity and a low chemical index will be best. 
